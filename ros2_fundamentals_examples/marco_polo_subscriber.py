...
class Marco_poloSubscriber(Node):
    ...
    def __init__(self):
        ...
        super().__init__('marco_polo_subscriber')
    ...
    def listener_callback(self, msg):
        ...
        self.get_logger().info(f'I heard "{msg.data}" ({text} characters)')
...
def main(args=None):
    ...
    marco_polo_subscriber = Marco_poloSubscriber()
 
    # Keep the node running and processing events.
    rclpy.spin(marco_polo_subscriber)
 
    # Destroy the node explicitly
    # (optional - otherwise it will be done automatically
    # when the garbage collector destroys the node object)
    marco_polo_subscriber.destroy_node()
